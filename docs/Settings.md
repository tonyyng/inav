...
| nav_wp_load_on_boot | OFF | If set to ON, any waypoint mission that is stored in EEPROM will be loaded during FC boot.  It can be unloaded using stick commands. |
